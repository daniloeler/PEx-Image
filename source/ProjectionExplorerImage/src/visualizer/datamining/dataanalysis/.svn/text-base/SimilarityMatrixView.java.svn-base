...
public class SimilarityMatrixView extends javax.swing.JDialog {
        ...
        if (this.pointsRadioButton.isSelected()) {
            if (this.pointsTextField.getText().trim().length() > 0) {
                try {
                    ...
                    SimilarityMatrix.getInstance(this).display(dmat);
    ...
    public static SimilarityMatrixView getInstance(javax.swing.JFrame parent) {
        return new SimilarityMatrixView(parent);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SimilarityMatrixView dialog = new SimilarityMatrixView(new javax.swing.JFrame());
