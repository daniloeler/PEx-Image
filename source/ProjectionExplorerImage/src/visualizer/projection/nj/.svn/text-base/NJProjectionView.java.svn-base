 ...
 * @author  Ana Maria
 */
public class NJProjectionView extends ProjectionView {

    /** Creates new form BeanForm */
    public NJProjectionView(ProjectionData pdata) {
        super(pdata);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Neighbor Joining"));
