 ...
 */
public class MSTProjectionView extends ProjectionView {

    /** Creates new form MSTProjectionView */
    public MSTProjectionView(ProjectionData pdata) {
        super(pdata);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Minimum Spanning Tree Projection (MSTProj)"));
        ...
        add(statusPanel, new java.awt.GridBagConstraints());
