 ...
 */
public class ProjClusProjectionView extends ProjectionView {

    private static final long serialVersionUID = 1L;
    /**
     * Creates new form ProjClusProjectionView
     * @param pdata 
     */
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("ProjClus Projection"));
        ...
        clusterFactorTextField.setText("4.5");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
