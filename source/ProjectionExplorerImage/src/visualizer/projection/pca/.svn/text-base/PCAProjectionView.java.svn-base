 ...
 */
public class PCAProjectionView extends ProjectionView {

    /** Creates new form PCAProjectionView */
    public PCAProjectionView(ProjectionData pdata) {
        super(pdata);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Principal Components Analysis (PCA)"));
