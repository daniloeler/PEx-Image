...
public class DissimilarityFactory {
    ...
    public static Dissimilarity getInstance(DissimilarityType type) {
        ...
        } else if (type == DissimilarityType.COSINE_BASED) {
            return new CosineBased();
        } else if (type == DissimilarityType.EUCLIDEAN) {
            return new Euclidean();
        } else if (type == DissimilarityType.EXTENDED_JACCARD) {
            return new ExtendedJaccard();
        } else if (type == DissimilarityType.INFINITY_NORM) {
