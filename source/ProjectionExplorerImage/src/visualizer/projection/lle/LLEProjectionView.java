 ...
 */
public class LLEProjectionView extends ProjectionView {
    
    /** Creates new form LLEProjectionView */
    public LLEProjectionView(ProjectionData pdata) {
        super(pdata);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder("Local Linear Embedding (LLE)"));
